...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    markReady: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:mark-ready",
      execute: (input: MarkThreadReadyInput) => markThreadReady(input),
      scheduler,
      concurrency,
    }),
    clearReady: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:clear-ready",
      execute: (input: ClearThreadReadyInput) => clearThreadReady(input),
      scheduler,
      concurrency,
    }),
